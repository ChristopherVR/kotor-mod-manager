...
export const en: Dict = {
  ...
  "builds.manualNeeded": "Manual install required",
  "builds.manualInstructions": "Open the folder below and follow the readme to finish installing this mod.",
  ...
  "builds.manualShowReadme": "Show readme",
  "builds.manualHideReadme": "Hide readme",
  "builds.viewError": "View error",
  "builds.addBuild": "Add build",
  "builds.addBuildTitle": "Add a mod build",
  "builds.addBuildHint": "Paste a build-guide page (like the built-in ones) and the app will read its mod list. Great for community or custom builds.",
  "builds.addBuildLabel": "Name",
  "builds.addBuildLabelPlaceholder": "My custom KOTOR 1 build",
  "builds.addBuildGame": "Game",
  "builds.addBuildUrl": "Build guide URL",
  "builds.addBuildSubmit": "Add build",
  "builds.addBuildNoUrl": "Enter the build guide's web address first.",
  "builds.addBuildAdded": "Added build \"{label}\".",
  "builds.addBuildFailed": "Couldn't add build: {error}",
  "builds.deleteBuild": "Delete this build",
  "builds.deleteBuildConfirm": "Remove the custom build \"{label}\"? This only removes it from the app, not your game.",
  ...
  "modDetail.installError": "Why it failed",
  ...
  "conflicts.summaryClean": "All mods coexist cleanly",
  "conflicts.summaryDeclared": "{count} potential incompatibility",
  "conflicts.summaryDeclaredPlural": "{count} potential incompatibilities",
  "conflicts.summaryNotes": "{count} load-order note",
  "conflicts.summaryNotesPlural": "{count} load-order notes",
  ...
  "conflicts.sectionDeclared": "Potential incompatibilities",
  "conflicts.sectionDeclaredHint": "These mods flag each other as incompatible in their own readmes. If your build was curated for compatibility, issues may already be resolved - only act if you're actually experiencing problems.",
  "conflicts.sectionNotes": "Load-order notes",
  "conflicts.sectionNotesHint": "These mods share files. Install order determines which version is active - this is expected and handled automatically in curated builds.",
  "conflicts.wins": "wins",
  "conflicts.disabled": "disabled",
  "conflicts.sameBuild": "same build",
  "conflicts.noActionNeeded": "No action needed",
  "conflicts.loadOrder": "load order",
  "conflicts.ifIssuesDisable": "Only disable if you're experiencing in-game problems:",
