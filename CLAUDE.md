...
- Never add a `Claude-Session:` trailer or any other link back to an assistant
  session. These leak into the generated changelog and mean nothing to players.
  This applies to commit messages, PR descriptions, and issue comments.
